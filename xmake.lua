...
add_requires("vcpkg::spdlog 1.9.*", {alias = "spdlog"})
add_requires("vcpkg::fmt 7.1.*", {alias = "fmt"})
...
target("toy_jvm")
    ...
    add_files("src/classfile/constant_pool/*.cpp")
    add_files("src/classfile/attribute_info/*.cpp")
